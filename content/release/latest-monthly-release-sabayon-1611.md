...
* Daily images can always be found under the "daily" folder and these are incremental updates (though we can't guarantee these wil always be in a working state).
